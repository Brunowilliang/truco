...
import { AnimatedStack, HStack, Stack } from '@/components/ui/Stacks'
			...
			>
				...
				{groupedGames.length > 0 &&
					groupedGames.some(section => section.data.length > 0) && (
						<Button variant='danger' onPress={deleteAllGames}>
							<Button.Text>Apagar todas as partidas</Button.Text>
						</Button>
					)}
			</AnimatedStack>
		</Stack>
